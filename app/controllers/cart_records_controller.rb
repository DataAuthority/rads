class CartRecordsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @cart_record.save
        format.html { redirect_to cart_records_url, notice: 'Cart record was successfully created.' }
        format.json { render action: 'show', status: :created, location: @cart_record }
      else
        format.html { redirect_to cart_records_url, alert: 'Cart record was not successfully created.' }
