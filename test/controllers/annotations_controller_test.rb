...
class AnnotationsControllerTest < ActionController::TestCase
  ...
  test "should create annotation" do
    assert_difference('Annotation.count') do
      post :create, annotation: { context: @annotation.context, creator_id: @annotation.creator_id, record_id: @annotation.record_id, term: @annotation.term }
    end
  ...
  test "should update annotation" do
    patch :update, id: @annotation, annotation: { context: @annotation.context, creator_id: @annotation.creator_id, record_id: @annotation.record_id, term: @annotation.term }
    assert_redirected_to annotation_path(assigns(:annotation))
  end
